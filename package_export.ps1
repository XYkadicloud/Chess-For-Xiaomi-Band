...
$outputDir = Join-Path $root 'exports'
...
Copy-IfExists 'src'
Copy-IfExists 'dist'
Copy-IfExists 'backups'
Copy-IfExists 'README.md'
Copy-IfExists 'package.json'
Copy-IfExists 'package-lock.json'
Copy-IfExists '.npmrc'
Copy-IfExists 'jsconfig.json'
Copy-IfExists 'PROJECT_OVERVIEW.md'
Copy-IfExists 'PROJECT_SKILLS.md'
Copy-IfExists 'CONVERSATION_CHANGELOG.md'
Copy-IfExists 'AVAILABLE_SKILLS.md'
Copy-IfExists 'package_export.ps1'
